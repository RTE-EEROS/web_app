...
# ## Extract confidential ADEME data

#Import data collected in an excel file
df3 = pd.read_excel("Data_extrapolation_mass_windturbines_v5_confid_ADEME.xlsx",sheet_name='extract data confid ADEME')
df3
...
x_list = [x for x in df3[power]]
y_list = [y for y in df3[diameter]]
plt.plot(x_list, y_list, label='ADEME confidential data', marker = 'x', markersize = 5)
...
x_list = [x for x in df3[power]]
y_list = [y for y in df3[hub_height]]
plt.plot(x_list, y_list, label='ADEME confidential data', marker = 'x', markersize = 5)
...
x_list = [x for x in df3[power]]
y_list = [3*y for y in df3['Blade mass (t)']]
plt.plot(x_list, y_list, label='ADEME confidential data', marker = 'x', markersize = 5)
...
x_list = [x for x in df3[power]]
y_list = [y for y in df3[tower_mass]]
plt.plot(x_list, y_list, label='ADEME confidential data', marker = 'x', markersize = 5)
...
x_list = [x for x in df3[power]]
y_list = [y for y in df3[rotor_nacelle_mass]]
plt.plot(x_list, y_list, label='ADEME confidential data', marker = 'x', markersize = 5)
...
x_list = [x for x in df3[power]]
y_list = [y for y in df3[wind_turbine_mass]]
plt.plot(x_list, y_list, label='ADEME confidential data', marker = 'x', markersize = 5)
